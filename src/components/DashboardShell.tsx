      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="px-6 py-4 border-t border-gray-200">
            ...
            <p className="text-xs text-gray-400">Temple University</p>
          </div>
        </div>
      </aside>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 ml-auto">
            <span className="text-xs text-gray-400" id="last-refresh">
...
function RefreshButton() {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-teal-700 bg-teal-50 rounded-lg hover:bg-teal-100 disabled:opacity-50 transition-colors"
    >
      <svg
